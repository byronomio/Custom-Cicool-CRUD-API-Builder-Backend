...
<section class="content-header">
    <h1>
        Single Or Variant        <small>New Single Or Variant</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Single Or Variant</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/manage-form/form_single_or_variant/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
