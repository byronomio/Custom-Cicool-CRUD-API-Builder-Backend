...
<section class="content-header">
    <h1>
        Wp Woocommerce Order Itemmeta        <small><?= cclang('new', ['Wp Woocommerce Order Itemmeta']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Wp Woocommerce Order Itemmeta']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="meta_id" id="meta_id" placeholder="Meta Id" value="<?= set_value('meta_id'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="meta_key" id="meta_key" placeholder="Meta Key" value="<?= set_value('meta_key'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="meta_value" id="meta_value" placeholder="Meta Value" value="<?= set_value('meta_value'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/wp_woocommerce_order_itemmeta/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
