         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_brand" id="form_brand" >
                   
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Brand Id </label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($brand->brand_name); ?>
                        </div>
                    </div>
                                         
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Brand Desc </label>

                        <div class="col-sm-8">
                           <?= _ent($brand->brand_desc); ?>
                        </div>
                    </div>
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit brand (Ctrl+e)" href="<?= site_url('administrator/brand/edit/'.$brand->brand_id); ?>"><i class="fa fa-edit" ></i> <?= cclang('update', ['Brand']); ?> </a>
                        <?php }) ?>
