                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/brand/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="brand_name" id="brand_name" placeholder="Brand Name" value="<?= set_value('brand_name', $brand->brand_name); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="brand_desc" name="brand_desc" rows="10" cols="80"> <?= set_value('brand_desc', $brand->brand_desc); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
