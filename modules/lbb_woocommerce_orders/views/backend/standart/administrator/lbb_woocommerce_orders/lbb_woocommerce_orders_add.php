...
<section class="content-header">
    <h1>
        Lbb Woocommerce Orders        <small><?= cclang('new', ['Lbb Woocommerce Orders']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Lbb Woocommerce Orders']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <textarea id="customer_user_agent" name="customer_user_agent" rows="5" cols="80"><?= set_value('Customer User Agent'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="reason" name="reason" rows="5" cols="80"><?= set_value('Reason'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/lbb_woocommerce_orders/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
