...
class Model_lbb_woocommerce_orders extends MY_Model {
    ...
    public function count_all($q = null, $field = null)
    {
        ...
        if (empty($field)) {
            foreach ($this->field_search as $field) {
                if ($iterasi == 1) {
                    $where .= "lbb_woocommerce_orders.".$field . " LIKE '%" . $q . "%' ";
                } else {
                    $where .= "OR " . "lbb_woocommerce_orders.".$field . " LIKE '%" . $q . "%' ";
                }
                $iterasi++;
            }
    ...
    public function get($q = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
    {
        ...
        $this->db->limit($limit, $offset);
                $this->db->order_by('lbb_woocommerce_orders.'.$this->primary_key, "DESC");
                $query = $this->db->get($this->table_name);
    ...
    public function join_avaiable() {
        ...
        $this->db->select('lbb_woocommerce_orders.*');
...
/* End of file Model_lbb_woocommerce_orders.php */
/* Location: ./application/models/Model_lbb_woocommerce_orders.php */