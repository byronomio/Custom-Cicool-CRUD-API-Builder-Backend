...
<section class="content-header">
    <h1>
        Crud Input Chained        <small><?= cclang('new', ['Crud Input Chained']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Crud Input Chained']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="chain_field" id="chain_field" placeholder="Chain Field" value="<?= set_value('chain_field'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="chain_field_eq" id="chain_field_eq" placeholder="Chain Field Eq" value="<?= set_value('chain_field_eq'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="crud_field_id" id="crud_field_id" placeholder="Crud Field Id" value="<?= set_value('crud_field_id'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="crud_id" id="crud_id" placeholder="Crud Id" value="<?= set_value('crud_id'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/crud_input_chained/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
