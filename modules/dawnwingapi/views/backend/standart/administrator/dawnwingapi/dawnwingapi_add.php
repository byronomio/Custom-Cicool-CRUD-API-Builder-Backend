...
<section class="content-header">
    <h1>
        Dawnwingapi        <small><?= cclang('new', ['Dawnwingapi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dawnwingapi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="RecAdd6" id="RecAdd6" placeholder="RecAdd6" value="<?= set_value('RecAdd6'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="RecAdd7" id="RecAdd7" placeholder="RecAdd7" value="<?= set_value('RecAdd7'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dawnwingapi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
