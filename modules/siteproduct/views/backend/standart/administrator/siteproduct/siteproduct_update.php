            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/siteproduct/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="id" id="id" placeholder="Id" value="<?= set_value('id', $siteproduct->id); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="product_name" id="product_name" placeholder="Name" value="<?= set_value('product_name', $siteproduct->product_name); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sku" id="sku" placeholder="SKU" value="<?= set_value('sku', $siteproduct->sku); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="category_main[]" id="category_main" data-placeholder="Select Parent" multiple >
                                    ...
                                    <option <?=  in_array($row->category_name, explode(',', $siteproduct->category_main)) ? 'selected' : ''; ?> value="<?= $row->category_name ?>"><?= $row->category_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="category_sub[]" id="category_sub" data-placeholder="Select Child" multiple >
                                    ...
                                    <option <?=  in_array($row->category_sub_name, explode(',', $siteproduct->category_sub)) ? 'selected' : ''; ?> value="<?= $row->category_sub_name ?>"><?= $row->category_sub_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="brand[]" id="brand" data-placeholder="Select Brands" multiple >
                                    ...
                                    <option <?=  in_array($row->brand_name, explode(',', $siteproduct->brand)) ? 'selected' : ''; ?> value="<?= $row->brand_name ?>"><?= $row->brand_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <label>
                                    <input <?=  in_array($row->id, explode(',', $siteproduct->simpleorvariant)) ? 'checked' : ''; ?> type="checkbox" class="flat-red" name="simpleorvariant[]" value="<?= $row->id ?>"> <?= $row->id; ?>
                                    </label>
                                    </div>
                                    <?php endforeach; ?>  
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="price" id="price" placeholder="Price" value="<?= set_value('price', $siteproduct->price); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="description" name="description" rows="5" class="textarea form-control"><?= set_value('description', $siteproduct->description); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="whatsinthebox" name="whatsinthebox" rows="5" class="textarea form-control"><?= set_value('whatsinthebox', $siteproduct->whatsinthebox); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="siteproduct_first_image_uuid" id="siteproduct_first_image_uuid" type="hidden" value="<?= set_value('siteproduct_first_image_uuid'); ?>">
                                <input class="data_file" name="siteproduct_first_image_name" id="siteproduct_first_image_name" type="hidden" value="<?= set_value('siteproduct_first_image_name', $siteproduct->first_image); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="siteproduct_second_image_uuid" id="siteproduct_second_image_uuid" type="hidden" value="<?= set_value('siteproduct_second_image_uuid'); ?>">
                                <input class="data_file" name="siteproduct_second_image_name" id="siteproduct_second_image_name" type="hidden" value="<?= set_value('siteproduct_second_image_name', $siteproduct->second_image); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="siteproduct_gallery_galery_listed">
                                <?php foreach ((array) explode(',', $siteproduct->gallery) as $idx => $filename): ?>
                                    <input type="hidden" class="listed_file_uuid" name="siteproduct_gallery_uuid[<?= $idx ?>]" value="" /><input type="hidden" class="listed_file_name" name="siteproduct_gallery_name[<?= $idx ?>]" value="<?= $filename; ?>" />
                                <?php endforeach; ?>
                                </div>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="website[]" id="website" data-placeholder="Select Websites" multiple >
                                    ...
                                    <option <?=  in_array($row->website_name, explode(',', $siteproduct->website)) ? 'selected' : ''; ?> value="<?= $row->website_name ?>"><?= $row->website_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="status[]" id="status" data-placeholder="Select Status" multiple >
                                    ...
                                    <option <?=  in_array($row->status_name, explode(',', $siteproduct->status)) ? 'selected' : ''; ?> value="<?= $row->status_name ?>"><?= $row->status_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_siteproduct.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#siteproduct_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#siteproduct_first_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/siteproduct/get_first_image_file/<?= $siteproduct->id; ?>',
       ...
       $('#siteproduct_second_image_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/siteproduct/get_second_image_file/<?= $siteproduct->id; ?>',
             refreshOnRequest:true
           },
          multiple : false,
          validation: {
       ...
       $('#siteproduct_gallery_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/siteproduct/get_gallery_file/<?= $siteproduct->id; ?>',
             refreshOnRequest:true
           },
          validation: {
              allowedExtensions: ["*"],
